...
for workpiece_name in workpiece_names:
    ...
    #candidate_rotations, [xy_shadows,xy_shadow_angles] = pose_finder.find_candidate_rotations_by_resting_face_normal_alignment()
    ...
    symmetrically_unique_rotations = pose_finder.symmetry_handler(stable_rotations)
